...
public partial class AddDocumentPage : ContentPage
{
    ...
    private async void OnSaveClicked(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(DocumentNameEntry.Text))
        {
            await DisplayAlertAsync("Error", "Please enter a document name", "OK", "");
            return;
        }
        ...
        try
        {
            ...
            {
                FileName = DocumentNameEntry.Text,
                Category = "documents",
            ...
            await DisplayAlertAsync("Success", "Document uploaded successfully!", "OK", "");
