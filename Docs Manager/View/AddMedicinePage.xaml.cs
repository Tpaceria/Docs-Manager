...
public partial class AddMedicinePage : ContentPage
{
    ...
    private async void OnPickFileClicked(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                PickerTitle = "Select a medicine file"
            });
    ...
    private async void OnSaveClicked(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlertAsync("Error", "Please enter a medicine name", "OK", "");
            return;
        }
        ...
        try
        {
            ...
            {
                FileName = MedicineNameEntry.Text,
                Category = "medicine",
            ...
            await DisplayAlertAsync("Success", "Medicine uploaded successfully!", "OK", "");
